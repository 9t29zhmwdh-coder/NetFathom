"""netfathom diagnose: auto-diagnose network health."""
...
from netfathom.output import emit_json, emit_yaml, print_diagnostic
...
def diagnose(target: str, fmt: str) -> None:
    ...
    Examples:
      netfathom diagnose
      netfathom diagnose --format json
      netfathom diagnose 192.168.1.0/24
    """

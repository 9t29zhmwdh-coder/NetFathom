...
from netfathom.health.models import HealthReport
from netfathom.models import (
    DiagnosticReport,
    DiscoverResult,
    ServicesResult,
    SpeedtestResult,
...
def print_changes(changes: list[dict]) -> None:
    ...
    table = Table(title=f"NetFathom Change Report ({len(changes)} changes)", box=box.ROUNDED)

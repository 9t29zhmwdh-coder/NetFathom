...
_ENV_VAR = "NETFATHOM_DB_PATH"
_DB_FILENAME = "netfathom.db"
_DATA_DIRNAME = "NetFathom-Data"
...
def resolve_db_path(override: str | None = None) -> Path:
    ...
    Precedence: explicit override > NETFATHOM_DB_PATH env var > portable
    ...
    data_dir = Path(user_data_dir("netfathom", appauthor=False))
    data_dir.mkdir(parents=True, exist_ok=True)
    return data_dir / _DB_FILENAME

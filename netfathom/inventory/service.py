...
from netfathom.enrichment.passive import enrich_host_passive
from netfathom.inventory.diff import ChangeRecord, SnapshotFields, diff_devices
from netfathom.inventory.identity import is_mac_randomized
from netfathom.models import DiscoverResult, Host, ServiceInfo, ServicesResult
from netfathom.storage.db import get_engine, get_session, init_db
from netfathom.storage.repository import InventoryRepository
...
class InventoryService:
    ...
    async def run_and_persist(
        ...
        from netfathom.cli.discover import run_discover_scan

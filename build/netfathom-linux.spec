...
Build: pyinstaller build/netfathom-linux.spec  (must run on Linux -- PyInstaller
does not cross-compile)
Output: dist/NetFathom-Start-Linux
...
executable bit, so this binary may need `chmod +x NetFathom-Start-Linux` or
